                                        ...
                                        <td style="text-align: center">
                                            <c:if test="${user.enabled}">
                                                <input type="submit" value="Disable"
                                                       onclick="document.forms[0].elements['action'].value='disableUser';document.forms[0].elements['login'].value='${user.login}';"/>
                                            </c:if>
                                            <c:if test="${not user.enabled}">
                                                <input type="submit" value="Enable"
                                                       onclick="document.forms[0].elements['action'].value='enableUser';document.forms[0].elements['login'].value='${user.login}';"/>
                                            </c:if>
                                        </td>
                                    </tr>
                                </c:forEach>
